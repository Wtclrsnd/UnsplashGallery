...
//        imageView.backgroundColor = .systemPink
    ...
    @objc private func buttonTapped() {
        if photo?.likedByUser == false {
            ...
            delegate?.update(photo: photo!) // reference types - 4e tam po ssylkam
            // delegate pattern - hackingwithswift.com || RW || avanderlee || sundell
//            LikedImages.shared.likedPhotos.append(photo!)
